...
Available commands:
  ...
  node ../cli/dist/index.js match select <commission-id> --executor <executor-pubkey> --keypair {{KEYPAIR}}
...
5. Select the bid with the LOWEST price: "node ../cli/dist/index.js match select <commission-id> --executor <executor-pubkey> --keypair {{KEYPAIR}}"
